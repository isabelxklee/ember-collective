...
function NavBar() {
  ...
  //   if (localStorage.token && isMobile) {
  //     return loggedInMobile
  //   } else if (localStorage.token && !isMobile) {
  //     return loggedInDesktop
  //   } else if (!localStorage.token && isMobile) {
  //     return guestMobile
  //   } else if (!localStorage.token && !isMobile) {
  //     return guestDesktop
  ...
  //   console.log("Desktop guest.")
  //   return "Desktop guest."
  // }
    ...
    return (
      ...
      { localStorage.token ? (
          <>
          <Navbar.Wrapper>
            <Navbar.Item><NavLink to='/' onClick={handleLogout} className="header-link">Logout</NavLink></Navbar.Item>
          </Navbar.Wrapper>

          <MobileNavbar.Wrapper>
            <MobileNavbar.Item><NavLink to="/" exact className="navbar-link">Home</NavLink></MobileNavbar.Item>
            <MobileNavbar.Item><NavLink to="/police-brutality-tracker" exact className="navbar-link">Police Brutality</NavLink></MobileNavbar.Item>
            <MobileNavbar.Item><NavLink to="/resources" exact className="navbar-link">Resources</NavLink></MobileNavbar.Item>
          </MobileNavbar.Wrapper>
          </>
      ) : (
        <>
